...
func (app *Application) UploadFile(w http.ResponseWriter, r *http.Request)  {
	...
	switch filetype {
	case "task_service/jpeg", "task_service/jpg":
	case "task_service/gif", "task_service/png":
	...
	content = "\"error\":0,\"result\":{\"fileType\":\"task_service/png\",\"path\":\"" + path + "\",\"fileName\":\"ce73ac68d0d93de80d925b5a.png\"}"
	w.Write([]byte(start + content + end))
	return
}
